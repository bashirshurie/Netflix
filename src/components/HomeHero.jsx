  ...
  return (
    ...
    style={{
        ...
        <header className='flex w-full justify-between'>
            ...
            <div className='my-6 mx-4'>
                <Link className='rounded bg-[#e50a14] py-2 px-8 text-white'
                to="/login">
                    Sign in
                </Link>
            </div>
        ...
        text-center sm:px-20 text-white'>

            <h1 className='max-w-lg text-5xl font-bold tracking-wide '>
            ...
            <div className='m-4 flex flex-col space-y-6 sm:flex-row sm:space-y-0'>
                ...
                className='w-full min-w-[400px] bg-white text-black outline-none
                sm:p-4'/>
                <button className='flex w-full items-center justify-center bg-[#e50914]
                py-2 text-xl sm:py-0 sm:px-8'>
                    Get Started
