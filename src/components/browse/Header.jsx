...
const Header = () => {
  ...
  return (
    //lg:py-6 - waan ka reebay
    <header className={`${isIscroll && "bg-[#141414]"} fixed top-0 z-50 flex w-full justify-between items-center p-4 lg:px-10`}>
        <div className='flex items-center space-x-2 md:space-x-10'>
        <svg
                height="677"
                viewBox="0.238 0.034 919.406 248.488" width="2500"
                xmlns="http://www.w3.org/2000/svg" className="h-10 w-32 cursor-pointer">
                <path
        ...
        <div className='flex'>
            ...
            <Link to="/browse" className="link-style">My List</Link>
        </div>
